      ...
      <div ref="documentPrint">
        <div>
          ...
          <div style="margin-top: 3px">
            ...
            <div
              style="margin-top: 40px; float: right; margin-right: 65px; font-weight: 700"
            >
...
export default {
  ...
  methods: {
    ...
    getDataInitialPrint(idInfoEmployee, date, category, idList, description) {
      ...
      EmployeeSalaryService.getOrderSalaryPrint(idInfoEmployee, category, idList)
        .then((resp) => {
