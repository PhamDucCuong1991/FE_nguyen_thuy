  ...
  >
    ...
    <span slot="footer" class="dialog-footer">
      <el-button
        type="danger"
        size="medium"
        @click="closeDialogByButton('cameraForClassData')"
      >
...
export default {
  ...
  methods: {
    ...
    submitForm(fromData) {
      ...
      SchoolConfigService.updateCameraForClassSchool(this.idClass, dataList)
        .then((response) => {
    ...
    getCameraForClassInitial(id) {
      this.idClass = id;
      SchoolConfigService.findAllCameraForClassSchool(id)
        .then((resp) => {
