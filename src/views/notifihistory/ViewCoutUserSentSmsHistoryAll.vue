<template>
  <el-dialog
    title="Danh sách người nhận SMS"
  ...
  >
    ...
    <div class="table-content row-data">
      ...
      >
        ...
        <el-table-column label="Trạng thái " prop="fail" align="center ">
          <template slot-scope="scope">
            <span v-if="scope.row.fail">Thành công</span>
            <span v-else style="color: #f56c6c">Thất bại</span>
...
export default {
  ...
  methods: {
    ...
    getDetailMethodAll(id) {
      HistorySmsService.getByIdSmsAppSendAll(id)
        .then((resp) => {
