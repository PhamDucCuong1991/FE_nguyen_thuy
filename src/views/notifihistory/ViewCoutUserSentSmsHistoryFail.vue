<template>
  <el-dialog
    title="Danh sách người nhận thất bại"
  ...
  >
    ...
    <div class="table-content row-data">
      ...
      >
        ...
        <!-- <el-table-column prop="1" label="Trạng thái" align="center "
          >Thất bại</el-table-column
        > -->
      </el-table>
    </div>
  </el-dialog>
...
export default {
  ...
  methods: {
    ...
    getDetailMethodFail(id) {
      HistorySmsService.getByIdSmsAppSendFail(id)
        .then((resp) => {
