            ...
            >
              ...
              <el-table-column label="Chọn phòng ban" align="center">
                <template slot-scope="scope">
                  <el-checkbox v-model="scope.row.checkDepartment"></el-checkbox>
                </template>
              </el-table-column>
  ...
  methods: {
    ...
    getTabDepartmentInEmployee() {
      EmployeeDataService.getTabDepartmentInEmployeeById(this.idEmployeeEdit)
        .then((response) => {
          ...
          let a = this.formAllTabEmployee.tabDepartmentInEmployee;
          console.log(a);
        })
        .catch((err) => {
          console.log(err);
    ...
    getTabProfessionalInEmployee() {
      EmployeeDataService.getTabProfessionalInEmployeeById(this.idEmployeeEdit)
        .then((response) => {
          ...
          let a = this.formAllTabEmployee.tabProfessionalInEmployee;
          console.log(a);
        })
        .catch((err) => {
          console.log(err);
    ...
    tabTeacherIconMethod(id) {
      EmployeeDataService.findIconTeacherUpdate(id)
        .then((resp) => {
          let a = (this.teacherIconAppUpdate.teacherIconUpdate1 =
