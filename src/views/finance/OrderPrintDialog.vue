<template>
  <div style="visibility: hidden">
    <el-dialog
      class="andanh"
      title="In phiếu thu chi tổng hợp"
    ...
    >
        ...
        <div>
          ...
          >
            <el-table-column
              ...
              align="center"
            ></el-table-column>
            <el-table-column label="Tên khoản" width="180">
          ...
          <div style="margin-top: 3px">
            ...
            <div
              style="margin-left: 320px; text-align: center; font-weight: bold"
            >
      ...
      <span slot="footer" class="dialog-footer">
        <el-button type="success" size="medium" @click="exportToPDFMethod()">
...
export default {
  ...
  methods: {
    ...
    async printMethod(idKid, date, category, idList, description) {
      ...
      await FnFeesService.OrderPrint(idKid, category, idList)
        .then((resp) => {
