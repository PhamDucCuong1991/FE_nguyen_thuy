        ...
        <div>
          ...
          <div>
            <div style="float: left; font-size: 12px">
              ...
              <div style="font-size: 12px; font-style: italic; margin-bottom: 3px">
            ...
            <div style="float: right; font-size: 12px">
              ...
              <div style="margin-bottom: 3px; text-align: right">Đơn vị: VNĐ</div>
            </div>
          </div>
          <br />
          <br />
          ...
          >
            ...
            <el-table-column label="Giảm giá" align="right" width="80">
              <template slot-scope="scope">
            ...
            <!-- <el-table-column label="Đã chi" align="right" width="76">
              <template slot-scope="scope">
          ...
          <div style="font-size: 13px">Ngân hàng: {{ responseData.bankNameBank }}</div>
          ...
          <div style="margin-top: 10px">
            <strong style="margin-left: 50px">Người nhận tiền</strong>
            <div style="margin-left: 320px; text-align: center; font-weight: bold">
  ...
  methods: {
    ...
    exportToPDFMethod() {
      ...
      var opt = {
        margin: 0.2,
        filename:
          "PHIEU_CHI_PHHS_THANG_" + this.moment(this.date).format("MM_YYYY") + ".pdf",
    ...
    async printMethod(idKid, date, category, idList, description) {
      this.date = date;
      this.description = description;
      await FnFeesService.OrderPrintOut(idKid, category, idList)
        .then((resp) => {
    ...
    async getDataInitialPrint(idKid, date, category, idList, description) {
      await this.printMethod(idKid, date, category, idList, description);
