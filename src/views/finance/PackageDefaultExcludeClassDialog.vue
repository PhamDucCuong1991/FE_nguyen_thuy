<template>
  <el-dialog
    title="Thêm khoản mặc định cho nhiều học sinh"
...
export default {
  ...
  methods: {
    ...
    submitForm() {
      ...
      FnFeesService.updatePackageForDefaultPackageAddExcludeClass(idPackageList, this.idKidList)
        .then((resp) => {
          this.$message({
    ...
    getAddDataInitial(idKidList, idClass) {
      this.idKidList = idKidList;
      FnFeesService.getPackageForDefaultPackageAddExcludeClass(idClass)
        .then((resp) => {
